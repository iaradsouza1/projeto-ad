---
title: "Análise de dados: Bimanual"
...
# Obter Meta dados dos arquivos Bimanual ------------------------------------------------
meta <- get_metaData('04Bimanual')
...
Ao final do processo de detecção das fases do Bimanual, notou-se que, devido a heterogeinidade de formas do sinal, a rotina de deteção automática dos tempos limites não obteve sucesso em alguns casos, em especial para T4. Para solucionar o problema, realizou-se uma curadoria manual dos casos de falha.
...
#write_csv(picos,'../data/picosB.csv')
tmp <- ajusta_XY(picos,
          picosFile = '../data/picosB.csv',
...
picos <- read_csv('../data/picosB.csv')
...
Todos os testes indicaram um ρ > 0.73, confirmando assim a correlação entre os resultados obtidos pelo grupo de controle, M1 e M2.
...
# Análise das diferentes fases do Levantar+Bimanual

Para a análise das diferentes fases do levantar+Bimanual, foram utilizados os seguintes parâmetros : ÁreaCoP, Velocidade ântero-posterior, Velocidade médio-lateral, Amplitude de deslocamento do CoP ântero-posterior e Amplitude de deslocamento do CoP médio lateral (ML).
...
### Parâmetros analisados por fase do levantar+Bimanual
