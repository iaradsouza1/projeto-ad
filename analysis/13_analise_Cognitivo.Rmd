---
title: "Análise de dados: Cognitivo"
...
# Obter Meta dados dos arquivos Cognitivo ------------------------------------------------
meta <- get_metaData('03Cognitivo')
...
Ao final do processo de detecção das fases do Cognitivo, notou-se que, devido a heterogeinidade de formas do sinal, a rotina de deteção automática dos tempos limites não obteve sucesso em alguns casos, em especial para T4. Para solucionar o problema, realizou-se uma curadoria manual dos casos de falha.
...
#write_csv(picos,'../data/picosC.csv')
tmp <- ajusta_XY(picos,
          picosFile = '../data/picosC.csv',
...
picos <- read_csv('../data/picosC.csv')
...
Todos os testes indicaram um ρ > 0.71, confirmando assim a correlação entre os resultados obtidos pelo grupo de controle, M1 e M2.
...
# Análise das diferentes fases do Levantar+Cognitivo

Para a análise das diferentes fases do levantar+cognitivo, foram utilizados os seguintes parâmetros : ÁreaCoP, Velocidade ântero-posterior, Velocidade médio-lateral, Amplitude de deslocamento do CoP ântero-posterior e Amplitude de deslocamento do CoP médio lateral (ML).
...
### Parâmetros analisados por fase do levantar+cognitivo
