---
title: "Análise de dados: Levantar"
...
# Obter Meta dados dos arquivos Levantar ------------------------------------------------
meta <- get_metaData('01Levantar')
...
Ao final do processo de detecção das fases do levantar, notou-se que, devido a heterogeinidade de formas do sinal, a rotina de deteção automática dos tempos limites não obteve sucesso em alguns casos, em especial para T4. Para solucionar o problema, realizou-se uma curadoria manual dos casos de falha.
...
# Análise das diferentes fases do levantar

Para a análise das diferentes fases do levantar, foram utilizados os seguintes parâmetros : ÁreaCoP, Velocidade ântero-posterior, Velocidade médio-lateral, Amplitude de deslocamento do CoP ântero-posterior e Amplitude de deslocamento do CoP médio lateral (ML).
...
### Parâmetros analisados por fase do levantar
...
Salva dados de M1 para servir como referência para os outros testes de levantar.

```{r}
save(file = '../data/LevantarM1.RData', itv1)
```
